...
public class PickerController {
    ImageGalleryPickerActivity pickerActivity;
    ...
    PickerController(ImageGalleryPickerActivity pickerActivity, ActionBar actionBar, RecyclerView recyclerView, String bucketTitle) {
...
//                Log.d("photoFile path ", String.valueOf(photoFile));
    ...
    private File createImageFile(String saveDir) throws IOException {
        File image = new File(CameraUtils.createImageFile(pickerActivity).getPath());
